...
#  if [ "$CC_NAME" = "bmes-mgmt" ]; then
#    println $'\e[0;32m'chaincode-bmes-mgmt$'\e[0m' chaincode
#    CC_SRC_PATH="../chaincode-bmes-mgmt"
#  elif [ "$CC_NAME" = "bmes-prod" ]; then
#    println $'\e[0;32m'chaincode-bmes-prod$'\e[0m' chaincode
#    CC_SRC_PATH="../chaincode-bmes-prod"
#  
#  else
#    fatalln "The chaincode name ${CC_NAME} is not supported by this script. Supported chaincode names are: bmes-mgmt,bmes-prod"
  #fi
...
## Make sure that the path the chaincode exists if provided
  ...
  fatalln "Please assign CC_SRC_PATH with -ccp"
fi
